class TryAngle extends HTMLElement {
    constructor() {
        ...
        this.regimes = {
            "html5": { name: "html5", unit: "degrees", direction: 1, ratio: 1, offset: 0, minor: 1, major: 10, labelFunction: value => `${this.toFixedWithoutZeros(value, 3)}°` },
            "trig-degrees": { name: "trig-degrees", unit: "degrees", direction: -1, ratio: 1, offset: 0, minor: 1, major: 10, labelFunction: value => `${this.toFixedWithoutZeros(value, 3)}°` },
            ...
            "nav-marine": { name: "nav-marine", unit: "degrees", direction: 1, ratio: 1, offset: -90, minor: 1, major: 10, labelFunction: value => `${this.toFixedWithoutZeros(value, 3)}°` },
            "declination": {
