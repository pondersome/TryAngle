class TryAngle extends HTMLElement {
    constructor() {
        ...
        template.innerHTML = `
            ...
            <div id="main-container">
                ...
                <!-- Protractors and their svg container will be generated by JavaScript -->
            </div>
        `;
        ...
        this.BASE_RADIUS = 800 * 0.95; // Default base radius
        this.TAU = 2 * Math.PI;
        ...
        this.regimes = {
            "html5": { name: "html5", unit: "degrees", direction: 1, ratio: 1, offset: 0, minor: 1, major: 10, labelFunction: value => `${this.toFixedWithoutZeros(value, 2)}°` },
            "trig-degrees": { name: "trig-degrees", unit: "degrees", direction: -1, ratio: 1, offset: 0, minor: 1, major: 10, labelFunction: value => `${this.toFixedWithoutZeros(value, 2)}°` },
            ...
            "nav-marine": { name: "nav-marine", unit: "degrees", direction: 1, ratio: 1, offset: -90, minor: 1, major: 10, labelFunction: value => `${this.toFixedWithoutZeros(value, 2)}°` },
            "declination": {
        ...
        this.protractorSize = 800; // Default protractor size if not specified
    ...
    initializeProtractors() {
        ...
        //todo  build the svg dynamically here  and add it to main-container
        //<svg id="protractors" width="100%" height="100%" viewBox="0 0 600 600" preserveAspectRatio="xMidYMid meet">
        //the idea is to set the viewBox dimensions to this.protactorSize
        //also add a style to it of the form  flex: 0 1 600px; except the 600px is also set to this.protractorSize
        ...
        svgElement.setAttribute('id', 'protractors');
        svgElement.setAttribute('width', '100%');
        svgElement.setAttribute('height', '100%');
        svgElement.setAttribute('viewBox', `0 0 ${this.protractorSize} ${this.protractorSize}`);
        svgElement.setAttribute('preserveAspectRatio', 'xMidYMid meet');
        svgElement.style.flex = `0 1 ${this.protractorSize}px`;
    
        // Append the SVG element to the main container
        mainContainer.appendChild(svgElement);
    
        // Update the reference to the new SVG element
        this.protractorsContainer = svgElement;
    
        this.createProtractor(1, this.protractorSize/2, this.protractorSize/2, 1, this.defaultRotation1, this.initialRegime1);
        this.createProtractor(2, this.protractorSize/2, this.protractorSize/2, 0.75, this.defaultRotation2, this.initialRegime2);  // Example of overlapping protractors with different scales and regimes
    }
}
